...
var tableData = '<thead class="thead-dark"><tr><th>Exercise</th><th>Demo</th><th>Reps</th><th>Gear</th><th>Body Part</th></tr></thead>';

for (i = 0; i < selectedExercises.length; i++) {
    data = selectedExercises[i]
    tableData += '<tr><td>' + data.exerciseName + '</td><td>' + data.image + '</td><td>' + data.reps + '</td><td>' + data.equipment + '</td><td>' + data.bodyPart + '</td></tr>';
}

document.getElementById("thetable").innerHTML = tableData
